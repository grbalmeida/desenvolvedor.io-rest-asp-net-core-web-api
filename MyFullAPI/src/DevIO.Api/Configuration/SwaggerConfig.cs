...
namespace DevIO.Api.Configuration
{
    ...
    public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        {
            foreach (var description in provider.ApiVersionDescriptions) // Adds documentation for all versions of the API
            {
        ...
        static Info CreateInfoForApiVersion(ApiVersionDescription description)
        {
            var info = new Info()
            {
                ...
                Description = "This API is part of the REST course with ASP.NET Core WebAPI.",
